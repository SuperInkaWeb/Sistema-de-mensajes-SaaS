        ...
        <div className="min-h-screen bg-dark-900 flex items-center justify-center p-4">
            ...
            <div className="w-full max-w-md relative">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-white">WhatsApp SaaS</h1>
                    <p className="text-gray-400 mt-1">Crea tu cuenta empresarial</p>
                </div>

                <div className="card">
                    <h2 className="text-xl font-semibold text-white mb-6">Registrar Empresa</h2>
